...
export default function CategoriesSection({ initialDisplays, subcategoryDisplays = [] }: CategoriesSectionProps) {
                  ...
                  <div className="absolute inset-0">
                    {card ? (
                      <>
                        <Image
                          src={card.image_url}
                          alt={`${display.title_ar} ${subcat.name_ar}`}
                          fill
                  ...
                  <div className="relative h-full flex flex-col justify-end p-6 text-white">
                    <div>
                      <h3 className="text-2xl md:text-3xl font-bold mb-2 group-hover:translate-x-[-4px] transition-transform duration-300">
                        {display.title_ar} {subcat.name_ar}
                      </h3>
